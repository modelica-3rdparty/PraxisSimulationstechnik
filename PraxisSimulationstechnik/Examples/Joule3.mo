...
model Joule3
  ...
  Thermo.Devices.FluidSource fluidsource2 annotation(Placement(transformation(origin = {-108.034,-26.6667}, extent = {{-12,-12},{12,12}})));
  Thermo.Devices.Pump pump2(K = 0.001) annotation(Placement(transformation(origin = {-69.5172,-26.3908}, extent = {{-12,-12},{12,12}})));
  Thermo.Devices.Heater heater3 annotation(Placement(transformation(origin = {-23.4943,-26.3908}, extent = {{-12,-12},{12,12}})));
  Thermo.Devices.Turbine turbine2(K = 0.001) annotation(Placement(transformation(origin = {22.8505,-26.3908}, extent = {{-12,-12},{12,12}})));
  Thermo.Devices.Heater heater1 annotation(Placement(transformation(origin = {79.4943,-26.3908}, extent = {{-12,-12},{12,12}})));
  Thermo.Devices.FluidSink fluidsink2 annotation(Placement(transformation(origin = {114.253,-26.3908}, extent = {{-12,-12},{12,12}})));
  ...
  Thermo.Devices.StateMeasurement statemeasurement1 annotation(Placement(transformation(origin = {-92.046,-65.977}, extent = {{-12,-12},{12,12}}, rotation = -90)));
  Thermo.Devices.StateMeasurement statemeasurement2 annotation(Placement(transformation(origin = {-48.2759,-65.977}, extent = {{-12,-12},{12,12}}, rotation = -90)));
  Thermo.Devices.StateMeasurement statemeasurement3 annotation(Placement(transformation(origin = {0,-65.6552}, extent = {{-12,-12},{12,12}}, rotation = -90)));
  Thermo.Devices.StateMeasurement statemeasurement4 annotation(Placement(transformation(origin = {52.4598,-65.977}, extent = {{-12,-12},{12,12}}, rotation = -90)));
  Thermo.Devices.StateMeasurement statemeasurement5 annotation(Placement(transformation(origin = {98.8947,-67.2257}, extent = {{-12,-12},{12,12}}, rotation = -90)));
equation
  ...
  connect(statemeasurement1.inflow,fluidsource2.outflow) annotation(Line(points = {{-92.046,-53.977},{-92.3678,-53.977},{-92.3678,-26.7126},{-102.034,-26.7126},{-102.034,-26.6667}}));
  ...
  connect(fluidsource2.outflow,pump2.inflow) annotation(Line(points = {{-102.034,-26.6667},{-81.4253,-26.6667},{-81.4253,-26.3908},{-81.5172,-26.3908}}));
