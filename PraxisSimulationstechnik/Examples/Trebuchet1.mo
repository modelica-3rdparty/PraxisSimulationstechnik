...
model Trebuchet1
  ...
  PJlib.Kap17.RevoluteM revolutem1(theta0 = -140 * Modelica.Constants.pi / 180,
    length=0.4,
    radius=0.2)                                                                 annotation(Placement(transformation(origin = {-38.7808,33.1737}, extent={{-12,-12},
            {12,12}},                                                                                                    rotation = 90)));
  PJlib.Kap17.BodySphere bodysphere1(r = 0.1, rho = 3500,
    direction={0.9,0,0})                                                         annotation(Placement(transformation(origin = {44.9799,8.1025}, extent = {{-12,12},{12,-12}}, rotation = -90)));
  ...
  PJlib.Kap17.BodySphere bodysphere2(r = 0.4, rho = 3500,
    direction={0.9,0,0})                                                         annotation(Placement(transformation(origin = {-75.533,70.2108}, extent = {{-12,12},{12,-12}}, rotation = -180)));
equation
  connect(bodysphere2.frame_a1,bodycylinderwithpivot1.frame_a1) annotation(Line(points = {{-63.533,70.2108},{-45.0486,70.2108},{-45.0486,70.4956},{-45.3677,70.4956}}));
  ...
  connect(bodycylinder1.frame_a,bodysphere1.frame_a1) annotation(Line(points={{44.9799,
          36.5583},{45.1149,36.5583},{45.1149,20.1025},{44.9799,20.1025}}));
